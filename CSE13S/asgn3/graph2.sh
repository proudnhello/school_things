...
#remember to comment out the section on default functionality and uncomment the section for graph2.sh in play-dreidel.c
for a in {2..8}
do
    for i in {1..10000};
    do

        ./play-dreidel -p $a -c 3 -s $i >> results.dat
