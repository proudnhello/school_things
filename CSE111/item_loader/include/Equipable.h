...
class Equipable : public UseableItem {
	...
	public:
		...
		virtual bool is_equipable() const override { return true; }
		
        virtual double get_stats() const { return statsEffect; }
		virtual std::string get_slot() const { return slot; }
